...
pi_table<-pi%>%
  ...
  dplyr::select(Parameter, Device, Sampling, Detector, everything())%>%      mutate(Median = round(Median, 2),
         `2.5%CI` = round(`2.5%CI`, 2),
         `97.5%CI` = round(`97.5%CI`, 2))
