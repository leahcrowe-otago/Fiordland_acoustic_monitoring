...
table1<-daily_det_rate_table%>%
  ...
  #dplyr::rename("Total active listening days ($S_h$)" = "Device active days")%>%
  ...
  kableExtra::kable(table1, booktabs = T, align = "c", escape = F,
                    col.names = c(names(table1)[1:2],"Total active listening days (S_h)",names(table1)[4:7])) %>%
