...
Fig. S2. Example review window of mid-frequency, frequency-modulated dolphin sounds detected by the whistle detector. The blue box represents a 2-sec period horizontally and a frequency range up to 24 kHz vertically.
...
Fig. S6. The number of validated positive detections per day at the two sites within the Taumoana (Five Finger Peninsula) Marine Reserve.
